...
@section('content')
    <!-- HOME -->
    <section class="section-hero overlay inner-page bg-image" style="background-image:  url('{{ asset('assets/images/welder.jpg') }}');" id="home-section">
        <div class="container">
            <div class="row">
                <div class="col-md-7">
    ...
    <section class="py-5 bg-image overlay-primary fixed overlay" id="next-section" style="background-image:  url('{{ asset('assets/images/hero_1.jpg') }}');">
        <div class="container">
            ...
            <div class="row pb-0 block__19738 section-counter">
                ...
                <div class="col-6 col-md-6 col-lg-3 mb-5 mb-lg-0 text-dark">
                    <div class="d-flex align-items-center justify-content-center mb-2">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 mb-5 mb-lg-0">
                    <a data-fancybox data-ratio="2" href="https://vimeo.com/317571768" class="block__96788">
                        ...
                        <img src="{{ asset('assets/images/sq_img_4.jpg') }}" alt="Image" class="img-fluid img-shadow">
                    </a>
                </div>
                <div class="col-lg-5 ml-auto">
                    <h2 class="section-title mb-3">JobBoard For Contractors and Industrial Workers</h2>
    ...
    <section class="site-section">
        <div class="container">
            ...
            <div class="row align-items-center block__69944">
                ...
                <div class="col-md-6">
                    <img src="{{ asset('assets/images/person_2.jpg') }}" alt="Image" class="img-fluid mb-4 rounded">
                </div>
