...
<head><base href="">
    <meta charset="utf-8"/>
    <title>Roofer | Dashboard</title>
    <meta name="description" content="Updates and statistics"/>
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no"/>

    <!--begin::Fonts-->
    <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Work+Sans:ital,wght@0,300,400,500,600,700&display=swap"/>        <!--end::Fonts-->
...
<div class="d-flex flex-column flex-root">
    ...
    <div class="d-flex flex-row flex-column-fluid page">
        ...
        <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
            ...
            <!--begin::Content-->
            <div class="content  d-flex flex-column flex-column-fluid mx-12" id="kt_content">
                <!--begin::Subheader-->
